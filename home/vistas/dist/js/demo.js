...
(function ($) {
  ...
  $container.append(
    '<h5>Personalizar WithMp</h5><hr class="mb-2"/>'
  )

  $container.append('<h6>Administrar</h6>')
  ...
  var $header_fixed_container = $('<div />', { class: 'mb-1' }).append($header_fixed_checkbox).append('<span>Formas de Pago</span>')
